...
class JSONEditState(TypedDict):
    ...
    # additional fields for form integration 
    intent_type: Optional[str]  # 'NLI_EDIT', 'FORM_EDIT_STRUCTURED', 'FORM_EDIT_RAW', 'NO_EDIT'
    form_payloads: Optional[Dict[str, Any]]  # {'noael': {...}, 'dap': {...}}
    form_api_response: Optional[Dict[str, Any]]
    form_types_processed: Optional[List[str]]  # ['noael', 'dap']
